...
def argparser_prepare():
	...
	parser = argparse.ArgumentParser(description='',                      formatter_class=PrettyFormatter)
	parser.add_argument('-hs','--host', type=str, default='localhost', help='Postgresql host')
	parser.add_argument('-d','--database', type=str, default='osmot',                     help='Postgresql database')
	parser.add_argument('-u','--username', type=str, default='user',                     help='Postgresql username')    
	parser.add_argument('-p','--password', type=str, default='user',                     help='Postgresql password')
