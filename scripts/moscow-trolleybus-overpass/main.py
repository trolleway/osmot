...
def download_osm():
	import urllib
	#urllib.urlretrieve ('''http://overpass.osm.rambler.ru/cgi/interpreter?data=[timeout:86400];relation["route"="trolleybus"](55.620,37.510,55.91,37.85);(._;>;);out meta;''', "data.osm")
	urllib.urlretrieve ('''http://overpass-api.de/api/interpreter?data=[timeout:86400];relation["route"="trolleybus"](55.620,37.510,55.91,37.85);(._;>;);out meta;''', "data.osm")
